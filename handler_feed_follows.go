...
func (apiCfg *apiConfig) handlerCreateFeedFollow(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		respondWithError(w, 401, fmt.Sprintf("Couldn't create feed follow, %v", err))
		return
	}
...
func (apiCfg *apiConfig) handlerGetFeedFollows(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		respondWithError(w, 401, fmt.Sprintf("Couldn't get feed follow, %v", err))
		return
	}
...
func (apiCfg *apiConfig) handlerDeleteFeedFollows(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		respondWithError(w, 401, fmt.Sprintf("Couldn't delete feed follow, %v", err))
		return
	}
